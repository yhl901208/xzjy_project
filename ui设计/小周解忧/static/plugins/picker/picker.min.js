	...
	return function(e) {
		...
		function(t, i) {
			...
			return function(e) {
				...
				t.BScroll = function(e) {
					...
					return o(t, e), s(t, [{
							...
							"string" == typeof this.options.snap && (this.options.snap = this.scroller.querySelectorAll(this.options.snap)), this.on("refresh", function() {
								if (e.pages = [], e.wrapperWidth && e.wrapperHeight && e.scrollerWidth && e.scrollerHeight) {
									...
									if (e.options.snap === !0) for (o = Math.round(t / 2), s = Math.round(i / 2); n > -e.scrollerWidth;) {
										...
										n -= t, l++
									} else for (p = e.options.snap, c = p.length, u = -1; c > l; l++) f = (0, a.getRect)(p[l]), (0 === l || f.left <= (0, a.getRect)(p[l - 1]).left) && (h = 0, u++), e.pages[h] || (e.pages[h] = []), n = Math.max(-f.left, e.maxScrollX), r = Math.max(-f.top, e.maxScrollY), o = n - Math.round(f.width / 2), s = r - Math.round(f.height / 2), e.pages[h][u] = {
										x: n,
										y: r,
										width: f.width,
										height: f.height,
						...
						value: function(e, t) {
							...
							for (var n = this.pages.length; n > i; i++) if (e >= this.pages[i][0].cx) {
								e = this.pages[i][0].x;
								break
							}
							n = this.pages[i].length;
							for (var r = 0; n > r; r++) if (t >= this.pages[0][r].cy) {
								t = this.pages[0][r].y;
								break
							}
						...
						value: function() {
							...
							if (this.scrollerStyle[a.style.transitionDuration] = t + "ms", this.options.wheel && !a.isBadAndroid) for (var i = 0; i < this.itemLen; i++) this.items[i].style[a.style.transitionDuration] = t + "ms";
						...
						value: function(e) {
							if (this.scrollerStyle[a.style.transitionTimingFunction] = e, this.options.wheel && !a.isBadAndroid) for (var t = 0; t < this.itemLen; t++) this.items[t].style[a.style.transitionTimingFunction] = e
						}
					}, {
						key: "_transitionEnd",
						value: function(e) {
				...
				function a(e, t) {
					for (var i in t) if (t[i].test(e)) return !0;
					return !1
				}
				...
				var p = document.createElement("div").style,
					f = function() {
						...
						for (var t in e) if (void 0 !== p[e[t]]) return t;
						return !1
					}(),
					d = i("transform"),
				...
				t.EventEmitter = function() {
					...
					return o(e, [{
						...
						value: function(e) {
							...
							if (t) for (var n = t.length, o = [].concat(i(t)), s = 0; n > s; s++) {
								var a = o[s],
									l = r(a, 2),
									c = l[0],
									h = l[1];
		...
		t["default"] = function(e) {
			e.registerHelper("each", function(e, t) {
				...
				var n = t.fn,
					...
					c = void 0,
					h = void 0;
				if (t.data && t.ids && (h = r.appendContextPath(t.data.contextPath, t.ids[0]) + "."), r.isFunction(e) && (e = e.call(this)), t.data && (c = r.createFrame(t.data)), e && "object" == typeof e) if (r.isArray(e)) for (var u = e.length; u > a; a++) a in e && i(a, a, a === e.length - 1);
				else {
					var p = void 0;
		...
		function s(e, t) {
			...
			var r = {
				...
				lookup: function(e, t) {
					for (var i = e.length, n = 0; i > n; n++) if (e[n] && null != e[n][t]) return e[n][t]
				},
				lambda: function(e, t) {
